    ...
    <section className="text-indigo-600 ">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-lg mx-auto text-center">
          <h2 className="text-3xl font-bold sm:text-4xl">All Blogs</h2>

          <p className="mt-4 text-gray-800">Welcome to the BlogPlus</p>
        </div>
          ...
          {blogs.map((blog) => (
            ...
            >
              ...
              <p className="mt-1 text-md text-indigo-800">
                <Link href={"/blogs/" + blog.blog_id}>Click Here to Read</Link>
              </p>
            </div>
          ))}
        </div>
