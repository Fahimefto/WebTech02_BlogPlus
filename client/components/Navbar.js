      ...
      <div className="relative flex grid items-center grid-cols-2 lg:grid-cols-3">
        ...
        <ul className="flex items-center hidden ml-auto space-x-8 lg:flex">
          ...
          <li>
            <Link href="/signup">
              <a
                className="btn btn-primary inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide   transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                aria-label="Sign up"
                title="Sign up"
              >
                Sign up
