...
const Login = () => {
  return (
    <div class="relative h-screen">
      <div class="relative bg-primary bg-opacity-85">
        <svg
              ...
              <div class="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <div class="mt-4 mb-2 sm:mb-4">
                    <button
                      type="submit"
                      class="btn btn-primary inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide  transition duration-200 rounded shadow-md  hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                    >
                      Login
                    </button>
                  </div>
